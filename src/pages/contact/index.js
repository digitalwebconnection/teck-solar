...
export default function Contact() {
    return (<div className="bg-[#FAFAFA] min-h-screen selection:bg-amber-500 selection:text-white font-sans">
            ...
            <div className="w-full lg:w-5/12 relative z-10">
              <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-heading font-black text-slate-900 tracking-tighter leading-[1.05] mb-8">
                ...
                <span className="relative inline-block mt-2">
                  ...
                  <svg className="absolute w-full h-4 -bottom-3 left-0 text-amber-500" viewBox="0 0 100 10" preserveAspectRatio="none">
