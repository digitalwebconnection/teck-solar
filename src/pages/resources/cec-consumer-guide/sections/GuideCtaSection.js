...
export default function GuideCtaSection() {
    ...
    return (<section className="py-20 lg:py-24 bg-white relative">
        ...
        <div className="relative group rounded-2xl overflow-hidden shadow-xl shadow-slate-200/50">
          ...
          <div className="relative z-10 p-10 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="lg:max-w-xl text-center lg:text-left">
              ...
              <h2 className="text-3xl md:text-5xl font-heading font-extrabold text-white tracking-tight leading-[1.1]">
                ...
                <span className="text-amber-500 relative inline-block">
                  questions?
                  <svg className="absolute w-full h-3 -bottom-2 left-0 text-amber-500/50" viewBox="0 0 100 10" preserveAspectRatio="none">
            ...
            <div className="shrink-0 relative">
              ...
              <button type="button" onClick={openModal} className="relative inline-flex items-center justify-center gap-3 px-8 py-5 rounded-full bg-white text-slate-900 font-heading font-bold text-lg transition-all duration-300 hover:scale-105 hover:bg-slate-50 active:scale-95 shadow-xl group/btn cursor-pointer">
                Contact Our Team
