...
export default function GuideOverviewSection() {
    ...
    return (<section className="bg-[#FAFAFA] border-b border-slate-200 overflow-hidden relative">
      {/* Background Graphic */}
      ...
      <div className={`max-w-7xl mx-auto px-6 lg:px-12 py-8 lg:py-12 transition-all duration-1000 ease-out relative z-10 ${contentReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} ref={contentReveal.ref}>
        ...
        <div className="mt-20 flex justify-start">
          <a href="#download" className="group flex items-center gap-6 pb-2 border-b-2 border-slate-900 hover:border-[#E56D00] transition-colors duration-300">
