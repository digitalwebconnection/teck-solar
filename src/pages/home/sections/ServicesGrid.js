...
const services = [
    {
        ...
        description: "Transform your home with a customised solar power system designed to maximise savings and energy independence.",
        image: "/images/service-residential.jpg",
        link: "/services/residential-solar",
    },
    {
        title: "Commercial Solar",
        description: "Scalable solar solutions for businesses of all sizes. Reduce operational costs and boost your green credentials.",
        image: "/images/service-commercial.jpg",
        link: "/services/commercial-solar",
    },
    {
        title: "Battery Storage",
        description: "Store excess solar energy and power your home day and night with premium battery storage systems.",
        image: "/images/service-battery.jpg",
        link: "/services/battery-storage",
    },
    {
        title: "EV Charger",
        description: "Future-proof your property with smart EV charging solutions integrated with your solar system.",
        image: "/images/service-ev-charger.jpg",
        link: "/services/ev-charger",
    },
    {
        title: "Battery Materials",
        description: "We source only the highest quality battery cells and materials from trusted global manufacturers.",
        image: "/images/service-battery.jpg",
        link: "/services/battery-storage",
    },
    {
        title: "Charge Controllers",
        description: "Advanced MPPT and PWM charge controllers to optimise your solar system performance and battery life.",
        image: "/images/service-commercial.jpg",
        link: "/services/residential-solar",
    },
];
export default function ServicesGrid() {
    ...
    return (<section className="relative py-8 lg:py-12 px-4 sm:px-6 lg:px-8 bg-slate-50 overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className={`flex flex-col items-center text-center max-w-3xl mx-auto mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <div className={`relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_5%,black_95%,transparent)] pb-12 pt-4 transition-all duration-1000 delay-300 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
