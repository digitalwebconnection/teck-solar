...
export default function TestimonialsSection() {
  ...
  return (
    <section className="py-16 sm:py-20 lg:py-14 px-4 sm:px-6 lg:px-8 bg-navy-50/60 border-y border-navy-100/70 relative overflow-hidden" ref={ref}>
        ...
        >
          <div className="max-w-2xl">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-heading font-extrabold text-navy-900 tracking-tight leading-tight">
              Real Stories, Real <span className="bg-gradient-to-r from-primary-500 to-primary-700 bg-clip-text text-transparent">Solar Savings</span>
            </h2>

            <p className="mt-3 text-base sm:text-lg text-navy-600 leading-relaxed">
              Discover why over 2,500 Australian families and business owners recommend Teck Solar.
            </p>
          </div>
