...
export default function StorySection() {
    ...
    return (<section id="our-story" className="py-8 sm:py-10 lg:py-14 px-4 sm:px-6 lg:px-8 bg-white scroll-mt-12 border-b border-slate-100" ref={ref}>
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className={`lg:col-span-5 transition-all duration-700 delay-150 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            <div className="relative">
              {/* Main Image Frame */}
              <div className="rounded-xl overflow-hidden border border-slate-200/90 shadow-lg shadow-slate-900/5 bg-slate-50">
                <img src="/images/hero-installation.jpg" alt="Certified solar installation by Teck Solar technicians" className="w-full h-[400px] sm:h-[460px] object-cover"/>
              </div>
