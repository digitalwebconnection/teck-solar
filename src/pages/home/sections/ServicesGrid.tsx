...
export default function ServicesGrid() {
  ...
  return (
    <section
      className="py-16 sm:py-20 lg:py-14 px-4 sm:px-6 lg:px-8 bg-navy-50"
      ref={ref}
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-serif font-heading font-extrabold text-navy-900 mt-3">
            Our Services
          </h2>
