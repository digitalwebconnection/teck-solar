...
export default function ProductDatasheets() {
    return (<div className="bg-[#FAFAFA] min-h-screen selection:bg-[#E56D00] selection:text-white overflow-hidden">
      ...
      <div className="py-8 lg:py-12 border-b border-slate-200/50">
        <div className="max-w-7xl mx-auto px-4 w-full">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
            ...
            <div className="w-full lg:w-6/12 h-[400px] lg:h-[500px] relative perspective-[1000px]">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 bg-white border border-slate-100 rounded-[2rem] shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] transform rotate-[-4deg] p-6 flex flex-col z-10 transition-transform duration-700 hover:rotate-0 hover:-translate-y-[55%]">
                ...
                <div className="w-full h-40 rounded-2xl overflow-hidden mb-6 relative">
                  ...
                  <div className="absolute top-4 right-4 w-8 h-8 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center text-[#144E9A] shadow-sm">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                  </div>
                </div>

                <div className="flex justify-between items-center mb-2">
                  <span className="text-xs font-bold text-[#E56D00] uppercase tracking-widest">Datasheet</span>
                  <span className="text-[10px] font-bold text-[#144E9A] bg-[#144E9A]/10 px-2 py-1 rounded-full uppercase tracking-wider">v2.4</span>
                </div>
                
                <h3 className="text-2xl font-heading font-black text-slate-900 mb-6 leading-tight">Jinko Tiger Neo 440W</h3>
              ...
              <div className="absolute bottom-12 left-0 lg:left-12 w-64 p-5 bg-slate-900 border border-slate-800 rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.4)] transform rotate-[6deg] z-20 transition-transform duration-700 hover:-translate-y-4 hover:rotate-[2deg]">
      ...
      {/* Main Content Area */}
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 w-full pt-16 pb-32 relative z-10">
