...
export default function AboutHeroSection() {
    ...
    return (<>
      <section className="relative overflow-hidden bg-slate-50 py-8 lg:py-12 border-b border-slate-200">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
            ...
            <div className={`lg:col-span-7 lg:pr-8 xl:pr-16 flex flex-col items-center lg:items-start text-center lg:text-left transition-all duration-1000 ease-out ${heroReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`} ref={heroReveal.ref}>
              {/* Main Headline */}
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center lg:justify-start gap-4 mb-10 w-full">
                {checkpoints.map((item, idx) => (<div key={idx} className="inline-flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white border border-slate-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.08)] text-sm font-bold text-slate-700 w-full sm:w-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 w-full sm:w-auto">
                ...
                <a href="#our-story" className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-white border-2 border-slate-200 text-slate-700 font-heading font-bold text-lg transition-all duration-300 hover:border-brand-blue-500 hover:text-brand-blue-600 hover:-translate-y-1 w-full sm:w-auto">
            ...
            <div className={`lg:col-span-5 relative transition-all duration-1000 delay-300 ease-out ${imageReveal.visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`} ref={imageReveal.ref}>
              ...
              <div className="relative z-10 rounded-3xl overflow-hidden shadow-[0_20px_50px_-15px_rgba(20,72,140,0.3)] border-8 border-white mr-6 mb-6 bg-slate-100 group">
                ...
                <img src="/images/about-team.jpg" alt="Teck Solar certified installation team" className="w-full h-[400px] lg:h-[500px] object-cover transform transition-transform duration-1000 group-hover:scale-105"/>
              </div>
      ...
      <section className="py-16 lg:py-24 bg-slate-100 relative overflow-hidden border-b border-slate-200">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 transition-all duration-1000 ease-out ${statsReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`} ref={statsReveal.ref}>
            {stats.map((item, i) => (<div key={i} className="group relative bg-white rounded-xl p-8 border border-slate-200 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] hover:border-brand-blue-200 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-8">
                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-colors duration-500 ${item.color === "orange"
                ...
                : "bg-gradient-to-br from-[#144E9A]/10 to-brand-blue-500/10 text-[#144E9A] group-hover:bg-[#144E9A] group-hover:text-white"}`}>
                  ...
                  <div className="flex items-baseline gap-1 mb-3">
                    <span className={`text-5xl font-heading font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-r ${item.color === "orange"
                ? "from-[#E56D00] to-orange-400"
                : "from-[#144E9A] to-brand-blue-500"}`}>
                      {item.number}
                    </span>
                    <span className={`text-2xl font-heading font-black ${item.color === "orange"
                ? "text-[#E56D00]"
                : "text-[#144E9A]"}`}>
                      {item.symbol}
                    </span>
