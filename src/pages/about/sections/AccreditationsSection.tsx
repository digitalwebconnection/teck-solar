...
export default function AccreditationsSection() {
  ...
  return (
    <section
      className="py-14 sm:py-18 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white border-b border-slate-100"
      ref={ref}
    >
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
          ...
          <div
            className={`lg:col-span-7 space-y-3.5 transition-all duration-700 delay-100 ${
              visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"
            }`}
          >
            {accreditations.map((item) => (
              <div
                key={item.id}
                className="group relative bg-white rounded-2xl p-5 sm:p-6 border border-slate-200/80 hover:border-brand-blue-400 hover:shadow-lg hover:shadow-brand-blue-900/5 hover:-translate-y-0.5 transition-all duration-300 flex items-start gap-4 sm:gap-5"
              >
                ...
                <div
                  className={`w-11 h-11 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 shadow-xs mt-0.5 ${
                    item.accent === "orange"
