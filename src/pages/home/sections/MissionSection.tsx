...
export default function MissionSection() {
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-white overflow-hidden" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div
            className={`lg:col-span-6 xl:col-span-7 transition-all duration-700 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
              }`}
          >
            ...
            <p className="text-navy-500 text-base sm:text-sm leading-relaxed">
              How can we meet the growing demand for electricity while protecting our climate and make planet a better place? At Teck Solar, we bridge this gap by delivering accessible, high-efficiency solar energy systems that empower every Australian home and enterprise.
            </p>
          ...
          <div
            className={`lg:col-span-6 xl:col-span-5 relative transition-all duration-700 delay-200 ${visible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
              }`}
          >
