...
const features = [
    {
        ...
        description: "Every installation meets the highest Australian standards. We use premium-tier panels, inverters, and mounting systems.",
    },
    {
        icon: (<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        title: "Simple & Easy",
        description: "From initial consultation to final installation, our streamlined process makes going solar effortless.",
    },
    {
        icon: (<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: "Our team holds full CEC (Clean Energy Council) accreditation, ensuring compliance and eligibility for rebates.",
    },
    {
        icon: (<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        description: "We partner with world-leading manufacturers to deliver products with up to 25-year performance warranties.",
    },
];
export default function WhyChooseUs() {
    const { ref, visible } = useReveal(0.15);
    return (<section className="relative py-20 sm:py-24 lg:py-14 bg-fixed bg-cover bg-center bg-no-repeat overflow-hidden" style={{ backgroundImage: "url('/images/hero-installation.jpg')" }} ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        {/* Section Header */}
        <div className={`text-center max-w-3xl mx-auto mb-14 lg:mb-16 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-7">
          {features.map((feat, i) => {
            ...
            return (<div key={i} className={`text-center group transition-all duration-500 flex flex-col items-center ${visible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 100}ms` }}>
