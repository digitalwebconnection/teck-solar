...
export default function Header() {
  ...
  return (
    <>
      {/* Top Utility Bar - Clean, bright, white theme */}
      <div className="w-full bg-slate-50 border-b border-slate-200/80 text-slate-600 text-xs py-2">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 w-full">
          {/* Left contact info */}
          <div className="flex items-center gap-5 sm:gap-6">
            {/* Phone with Availability Dot */}
            <a
              href="tel:1300000832"
              className="flex items-center gap-2 font-semibold text-slate-800 hover:text-primary-600 transition-colors group"
            >
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 hover:text-primary-600 transition-colors text-slate-600"
            >
              <svg
          ...
          {/* Right badges & WhatsApp */}
          <div className="flex items-center gap-3 sm:gap-4 ml-auto">
            {/* Accreditation Badge */}
            <div className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-white border border-slate-200 text-slate-700 text-[11px] font-medium shadow-2xs">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-eco-600 hover:text-eco-700 font-medium transition-colors"
            >
              <svg
