    ...
    <footer className="bg-white border-t border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-14 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-4">
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-slate-900 font-semibold text-base mb-4 flex items-center gap-2">
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-sm text-slate-600 hover:text-primary-600 transition-colors duration-150 inline-block"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="space-y-3.5 text-sm">
              ...
              <div className="space-y-2.5">
                {officeLocations.map((address, index) => (
                  <div key={index} className="flex items-start gap-2.5 text-slate-600">
              ...
              <div className="flex items-center gap-2.5 pt-2 border-t border-slate-100">
                ...
                <a href="tel:1300134077" className="text-sm font-semibold text-slate-800 hover:text-primary-600 transition-colors">
                  1300 134 077
                </a>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:info@teck-solar.com.au" className="text-sm font-medium text-slate-800 hover:text-primary-600 transition-colors">
      ...
      <div className="border-t border-slate-200 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500 w-full">
