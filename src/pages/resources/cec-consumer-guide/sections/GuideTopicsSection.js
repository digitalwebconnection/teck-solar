...
export default function GuideTopicsSection() {
    ...
    return (<div className=" py-8 lg:py-12" ref={topicsReveal.ref}>
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="border-t-2 border-slate-900">
          {guideTopics.map((topic, i) => (<div key={i} className={`group border-b border-slate-200 py-10 lg:py-14 px-5 flex flex-col md:flex-row gap-8 lg:gap-16 transition-all duration-700 ease-out hover:bg-slate-200 ${topicsReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${i * 100}ms` }}>
              {/* Chapter Number */}
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-x-8 gap-y-4">
                  {topic.tips.map((tip, ti) => (<div key={ti} className="flex items-center gap-3">
