      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col items-center lg:items-end gap-4 shrink-0 w-full lg:w-auto relative z-10">
            <a
              href="tel:1300000000"
              className="inline-flex items-center justify-center gap-2 sm:gap-3 px-6 py-3.5 sm:px-10 sm:py-5 rounded-2xl bg-brand-blue-500 text-white font-heading font-bold text-lg sm:text-xl transition-all duration-300 hover:bg-brand-blue-600 hover:shadow-xl hover:-translate-y-1 w-full sm:w-auto group"
            >
              <svg
