...
function AnimatedCounter({ target, prefix = "", start = false, }) {
...
export default function StatsSection() {
    ...
    return (<section className="py-8 lg:py-12 bg-slate-100 relative overflow-hidden border-b border-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={ref}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {trustStats.map((item, index) => (<div key={item.id} className={`group relative bg-white rounded-xl p-8 border border-slate-200 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] hover:border-brand-blue-200 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col ${visible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-12"}`} style={{ transitionDelay: `${index * 120}ms` }}>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col mb-8 gap-4">
                  <div className={`w-14 h-14 rounded-xl flex items-center justify-center transition-colors duration-500 ${item.color === "orange"
