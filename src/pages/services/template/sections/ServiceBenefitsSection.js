...
export default function ServiceBenefitsSection({ title, benefits, }) {
    ...
    return (<section className="py-8 sm:py-14 bg-slate-50 relative overflow-hidden flex flex-col items-center" ref={benefitsReveal.ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className={`text-center mb-12 sm:mb-16 transition-all duration-1000 ease-out ${benefitsReveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
      ...
      <div className="w-full relative z-10 flex flex-col gap-4 sm:gap-6 overflow-hidden">
        ...
        <div className="flex w-max animate-marquee hover:[animation-play-state:paused] group">
          {marquee1.map((b, i) => (<div key={`row1-${i}`} className="w-[300px] sm:w-[360px] shrink-0 bg-white p-6 sm:p-7 rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgb(20,72,140,0.06)] mx-2 sm:mx-3 flex flex-col gap-4 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(20,72,140,0.15)] hover:-translate-y-1">
        ...
        <div className="flex w-max animate-marquee-reverse hover:[animation-play-state:paused] group">
          {marquee2.map((b, i) => (<div key={`row2-${i}`} className="w-[300px] sm:w-[360px] shrink-0 bg-white p-6 sm:p-7 rounded-3xl border border-slate-100 shadow-[0_8px_30px_rgb(20,72,140,0.06)] mx-2 sm:mx-3 flex flex-col gap-4 transition-all duration-300 hover:shadow-[0_20px_40px_-15px_rgba(20,72,140,0.15)] hover:-translate-y-1">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-blue-50 to-brand-blue-100 text-brand-blue-600 flex items-center justify-center shrink-0 shadow-inner group-hover/card:scale-110 transition-transform duration-500">
                {b.icon}
              </div>
              <div>
