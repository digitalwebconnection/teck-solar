...
export default function MissionSection() {
    ...
    return (<section className="relative py-6 sm:py-8 lg:py-12 bg-white overflow-hidden border-b border-slate-200" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          <div className={`lg:col-span-6 xl:col-span-7 transition-all duration-1000 ease-out ${visible
          ...
          <div className={`lg:col-span-6 xl:col-span-5 relative transition-all duration-700 delay-200 ${visible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}>
            <div className="relative mx-auto max-w-lg lg:max-w-none">
              ...
              <div className="relative rounded-t-full overflow-hidden shadow-2xl shadow-slate-900/15 border border-slate-200 bg-slate-900 group">
                <img src="/images/mission-solar.jpg" alt="Modern solar panels in green field under bright sun" className="w-full h-[380px] sm:h-[460px] lg:h-[520px] object-cover group-hover:scale-105 transition-transform duration-700 ease-out"/>
