...
export default function ServiceIntroSection({ title, intro, introDetail, featureImage, }) {
    const introReveal = useReveal();
    const imageReveal = useReveal();
    return (<section className="py-8 lg:py-14 bg-white relative overflow-hidden" ref={introReveal.ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 relative pt-6 pr-6">
            <div ref={imageReveal.ref} className={`relative transition-all duration-1000 delay-200 ease-out ${imageReveal.visible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16'}`}>
              ...
              <div className="relative z-10 w-full aspect-[4/5] rounded-[2rem] overflow-hidden shadow-[0_20px_50px_-15px_rgba(20,72,140,0.3)] border-8 border-white mr-8 mb-8 bg-slate-100">
                ...
                <img src={featureImage} alt={title} className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-1000"/>
              </div>
          ...
          <div className={`lg:col-start-7 lg:col-span-6 transition-all duration-1000 ease-out ${introReveal.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <button type="button" onClick={openModal} className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-brand-blue-900 text-white font-heading font-bold text-lg transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto overflow-hidden shadow-[0_10px_20px_-10px_rgba(20,72,140,0.5)] cursor-pointer">
