        ...
        <div className="bg-white border border-brand-blue-100 shadow-[0_8px_30px_rgb(20,72,140,0.08)] rounded-3xl overflow-hidden relative flex flex-col items-center justify-center p-12 lg:p-20 gap-10 text-center">
          ...
          <div className="max-w-3xl relative z-10">
            ...
            <p className="mt-6 text-slate-600 text-lg sm:text-xl leading-relaxed font-medium">
              Contact our experts today for a free, no-obligation consultation.
              We'll design the perfect solution tailored specifically to your
              energy needs.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full relative z-10">
            ...
            <a
              href="tel:1300000000"
              className="group relative inline-flex items-center justify-center gap-2 sm:gap-3 px-6 py-3 sm:px-8 sm:py-4 rounded-xl bg-[#144E9A] text-white font-heading font-bold text-base sm:text-lg transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto overflow-hidden shadow-[0_10px_20px_-10px_rgba(20,78,154,0.5)]"
            >
              ...
              <span className="relative z-10">Call 1300 134 077</span>
            </a>
          </div>
        </div>
      </div>
