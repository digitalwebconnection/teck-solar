...
function AnimatedCounter({ target, suffix = '', prefix = '', start = false }: { target: number; suffix?: string; prefix?: string; start: boolean }) {
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-14 bg-linear-to-b from-navy-50/70 via-white to-navy-50/40 border-y border-navy-100/70 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={ref}>
        {/* Section Header */}
        <div className={`text-center max-w-5xl mx-auto mb-12 sm:mb-10 transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-heading font-extrabold text-navy-900 tracking-tight leading-tight">
            Numbers That Speak <span className="bg-gradient-to-r from-primary-500 to-primary-700 bg-clip-text text-transparent">Trust</span>
          </h2>

          <p className="mt-4 text-base sm:text-lg text-navy-600 max-w-6xl mx-auto leading-relaxed">
            Real outcomes delivered across Australia with certified standards, Tier-1 engineered components, and decades of guaranteed reliability.
          </p>
        </div>
