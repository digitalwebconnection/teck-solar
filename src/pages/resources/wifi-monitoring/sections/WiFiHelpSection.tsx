  ...
  return (
    <section className="py-16 bg-white" ref={reveal.ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div
          className={`bg-white border border-brand-blue-100 shadow-[0_8px_30px_rgb(20,72,140,0.08)] rounded-3xl overflow-hidden relative flex flex-col lg:flex-row items-center justify-between p-12 lg:p-20 gap-12 transition-all duration-700 ${reveal.visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
        >
          ...
          <div className="lg:max-w-2xl text-center lg:text-left relative z-10">
            ...
            <p className="mt-4 text-slate-500 text-base">
              Local experts available Monday to Friday, 8am to 5pm AEST to
              assist with any technical inquiries, troubleshooting, or
              documentation needs.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-end gap-4 shrink-0 w-full lg:w-auto relative z-10">
            <a
              href="tel:1300000000"
              className="inline-flex items-center justify-center gap-3 px-10 py-5 rounded-2xl bg-brand-blue-500 text-white font-heading font-bold text-xl transition-all duration-300 hover:bg-brand-blue-600 hover:shadow-xl hover:-translate-y-1 w-full sm:w-auto group"
            >
              <svg
